...
useEffect(() => {
loadNotifications();
// الاستماع لأي إشعار جديد لإضافته فوراً للقائمة
...
{unreadCount > 99 ? "99+" : unreadCount}
  ...
  {isOpen && (
    <div className="absolute left-0 sm:left-auto sm:right-0 mt-2 w-80 bg-white border border-slate-200 rounded-lg shadow-xl z-50 overflow-hidden flex flex-col max-h-[400px]">
